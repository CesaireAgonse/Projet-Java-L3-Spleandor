...
public class Demo {
  static class Area {
	...
	public void drawCard(ApplicationContext context, int x, int y) {
	    
	    Image img = Toolkit.getDefaultToolkit().getImage("./ressources/cards/boat-card.png");
	    System.out.println("Carte affichée");
        context.renderFrame(graphics -> {
          // show a new image at the current position
  ...
  public static void main(String[] args) {
    Application.run(Color.ORANGE, context -> {
      ...
      for(;;) {
        ...
        area.drawCard(context, (int)location.x, (int)location.y);
      }
    });
  }
}
